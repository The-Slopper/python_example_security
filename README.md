...
> Componente de seguranca: autenticacao, autorizacao e validacao de entrada.

## Visao geral

Security segue boas praticas de engenharia: estrutura de projeto idiomatica,
