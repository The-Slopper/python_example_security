...
| Campo | Valor |
|---|---|
| Repositorio | `python_example_security` |
...
Componente de seguranca: autenticacao, autorizacao e validacao de entrada. Este documento descreve requisitos, arquitetura e criterios de aceite.
...
Segue o scaffold idiomatico de Python: codigo-fonte, testes e manifesto de build
...
- [ ] `pip install -e .` conclui sem erros.
- [ ] `python -m app` executa o componente.
- [ ] `pytest` passa (CI verde, cobertura 100%).
